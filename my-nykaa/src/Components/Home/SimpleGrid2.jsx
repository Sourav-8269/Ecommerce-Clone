...
const SimpleGridExample2 = () => {
  ...
  return (
    <SimpleGrid columns={2} spacing={10} width="80%" margin="auto" marginBottom="5%"  >
        ...
        <Image position="" src="https://images-static.nykaa.com/uploads/8cd89b62-d26d-487e-a6d5-ff3d11abd416.jpg?tr=w-600,cm-pad_resize" />
        ...
        <Box boxShadow='2xl' rounded="md" position="relative">
        <Image src="https://images-static.nykaa.com/uploads/2e52e313-3cbe-41a8-86bd-0c3a9c7506e5.jpg?tr=w-600,cm-pad_resize" />
        <Box bg="white" width="10%"  style={style3} margin="auto">
            <Text color="pink.400" fontSize={20}>Upto 30% Off Expert Skincare Validated</Text>
        </Box>
        </Box>
        <Box boxShadow='2xl' rounded="md" position="relative"> 
        <Image src="https://images-static.nykaa.com/uploads/7c121349-cf97-4c5d-83cd-d8fe9214c39b.jpg?tr=w-600,cm-pad_resize" />
