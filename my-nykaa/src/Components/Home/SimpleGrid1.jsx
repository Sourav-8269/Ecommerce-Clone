  ...
  return (
    ...
    <SimpleGrid
      ...
      >
        ...
        <Box display={{xl:"block",base:"none"}} bg="white" width="10%"  style={style1} margin="auto">
        ...
        <Box display={{xl:"block",base:"none"}} bg="white" width="10%"  style={style2} margin="auto">
        ...
        <Box display={{xl:"block",base:"none"}} bg="white" width="10%"  style={style3} margin="auto">
        ...
        <Box display={{xl:"block",base:"none"}} bg="white" width="10%"  style={style4} margin="auto">
        ...
        <Box display={{xl:"block",base:"none"}} bg="white" width="10%"  style={style5} margin="auto">
        ...
        <Box display={{xl:"block",base:"none"}} bg="white" width="10%"  style={style6} margin="auto">
