...
// import { AiFillTwitterCircle } from 'react-icons/bi';
    ...
    <Box
          ...
          <Stack spacing={6}>
            ...
            <Stack direction={'row'} spacing={6}>
              <SocialButton label={'Twitter'} href={'#'}>
                ...
                <Link href="https://twitter.com/MyNykaa" isExternal={true} ><FaTwitter /></Link>
            
             
              </SocialButton>
              <SocialButton label={'YouTube'} href={'#'}>
                <Link href="https://www.youtube.com/channel/UCoaH2UtB1PsV7av17woV1BA" isExternal={true} ><FaYoutube /></Link>
              </SocialButton>
              <SocialButton label={'Instagram'} href={'#'}>
               <Link href="https://www.instagram.com/mynykaa/?ref=badge" isExternal={true} ><FaInstagram /></Link>
              </SocialButton>
            </Stack>
          </Stack>
      ...
      <Box bg="#fc2779" padding='1%'>
        <HStack color="white" justifyContent="center">
          ...
          <Text color="whitesmoke" fontWeight="600">© 2022 Nykaa E-Retail Pvt. Ltd. All Rights Reserved.</Text>
      </Box>
    </Box>
  );
}